...
class ListViewAdapter(var names: List<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        bindingFila.checkBox.setOnCheckedChangeListener { compoundButton, _ ->
            ...
            else MainActivity.seleccion.add(this.names[pos])
    ...
    override fun getItem(position: Int) = this.names[position]

    override fun getItemId(position: Int) = position.toLong()

    override fun getCount() = this.names.size
