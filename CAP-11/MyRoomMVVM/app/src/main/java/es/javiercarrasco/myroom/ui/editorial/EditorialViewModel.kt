...
class EditorialViewModel(private val supersRepository: SupersRepository) : ViewModel() {
...
class EditorialViewModelFactory(private val supersRepository: SupersRepository) :
    ViewModelProvider.Factory {

    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return EditorialViewModel(supersRepository) as T
    }
}